...
assert.deepEqual(L5_typecheck_1.L5typeof("(cons 1 1)"), "(Pair number number)");
assert.deepEqual(L5_typecheck_1.L5typeof("(car (cons 1 1))"), "number");
assert.deepEqual(L5_typecheck_1.L5typeof("(cdr (cons 1 #t))"), "boolean");
assert.deepEqual(L5_typecheck_1.L5typeof("(cdr (cons (cons 1 2) (cons 1 2)))"), "(Pair number number)");
assert.deepEqual(L5_typecheck_1.L5typeof("(cdr (cons (cons 1 2) (cons 1 #f)))"), "(Pair number boolean)");
assert.deepEqual(L5_typecheck_1.L5typeof("(car (cons (cons 1 2) (cons 1 #f)))"), "(Pair number number)");
assert.deepEqual(L5_typecheck_1.L5typeof("(car (cons (cons (cons #t #t) 2) (cons 1 #f)))"), "(Pair (Pair boolean boolean) number)");
assert.deepEqual(L5_typecheck_1.L5typeof("(cdr (cons (cons (cons #t #t) 2) (cons 1 #f)))"), "(Pair number boolean)");
