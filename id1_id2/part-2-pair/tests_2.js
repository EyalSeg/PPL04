...
// checking split
console.log(L5_type_equations_1.splitEquation(E.makeEquation(TExp_1.parseTE("(Pair number number)"), TExp_1.parseTE("(Pair number number)"))));
console.log([E.makeEquation(TExp_1.parseTE("number"), TExp_1.parseTE("number")), E.makeEquation(TExp_1.parseTE("number"), TExp_1.parseTE("number"))]);
...
assert.deepEqual(L5_type_equations_1.infer("(cons #f #t)"), "(Pair boolean boolean)");
console.log(L5_type_equations_1.infer("(car (cons #f #t))"));
...
//# sourceMappingURL=tests_2.js.map