...
// Define Tests 2.1
assert.deepEqual(L5_typecheck_1.L5typeof("(define (foo : number) 5)"), 'void');
console.log(L5_typecheck_1.L5typeof("(define (foo : number) (lambda (x y) (+ x y)))"));
assert.deepEqual(error_1.isError(L5_typecheck_1.L5typeof("(define (foo : number) (lambda (x y) (+ x y)))")), true);
console.log(L5_typecheck_1.L5typeof("(define (fact : (number -> number))\n(lambda ((n : number)) : number\n  (if (= n 0)\n    1\n    (* n (fact (- n 1))))))"));
assert.deepEqual(L5_typecheck_1.L5typeof("(define (fact : (number -> number))\n                    (lambda ((n : number)) : number\n                      (if (= n 0)\n                        1\n                        (* n (fact (- n 1))))))"), 'void');
assert.deepEqual(L5_typecheck_1.L5typeof("(define (f : (T1 -> T1))\n                        (lambda ((x : T1)) : T1 x))"), 'void');
assert.deepEqual(error_1.isError(L5_typecheck_1.L5typeof("(define (f : (number -> boolean))\n                      (lambda ((x : boolean)) : number x))")), true);
assert.deepEqual(error_1.isError(L5_typecheck_1.L5typeof("(define (f : (T1 -> T1))\n                            (lambda ((x : T1)) : T1 (+ x 1)))")), true);
//recursive
assert.deepEqual(L5_typecheck_1.L5typeof("(define (fact : (number -> number)) \n                              (lambda ((n : number)) : number\n                                  (if (= n 0)\n                                        1\n                                      (* n (fact (- n 1))))))"), 'void');
assert.deepEqual(L5_typecheck_1.L5typeof("(define (f : (T1 -> T1))\n                              (lambda ((y : T1)) : T1\n                                (f y)))"), 'void');
//program checks
//sanity
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (+ 1 1))"), 'number');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (= 0 1))"), 'boolean');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (x : number) (+ 1 1)) (* x 3))"), 'number');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (x : number) (+ 1 1)) (/ x 3))"), 'number');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (x : number) 1) (lambda ((x : number)) : number x))"), '(number -> number)');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (x : number) 1) ((lambda ((x : number)) : number x) x))"), 'number');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (x : number) (+ 1 1)) (= x 3))"), 'boolean');
//recursive defines
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (fact : (number -> number))\n                              (lambda ((n : number)) : number\n                                (if (= n 0)\n                                    1\n                                    (* n (fact (- n 1))))))\n                          (fact 5))"), 'number');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (fact : (number -> number))\n                              (lambda ((n : number)) : number\n                                (if (= n 0)\n                                    1\n                                    (* n (fact (- n 1))))))\n                                    (define (g : number) 5)\n                                (fact g))"), 'number');
assert.deepEqual(L5_typecheck_1.L5typeof("(L5 (define (fact : (number -> number))\n                              (lambda ((n : number)) : number\n                                (if (= n 0)\n                                    1\n                                    (* n (fact (- n 1))))))\n                                    (define (g : number) 5)\n                                (fact g)\n                              (define (bla : boolean) #t))"), 'void');
console.log('done');
//# sourceMappingURL=L5-typecheck-tests-part2.js.map