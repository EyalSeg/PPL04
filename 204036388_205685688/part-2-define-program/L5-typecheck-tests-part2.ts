...
console.log(L5typeof(`(define (foo : number) (lambda (x y) (+ x y)))`))
assert.deepEqual(isError(L5typeof(`(define (foo : number) (lambda (x y) (+ x y)))`)), true);
console.log(L5typeof(`(define (fact : (number -> number))
...
//recursive defines
assert.deepEqual(L5typeof(`(L5 (define (fact : (number -> number))
                              (lambda ((n : number)) : number
                                (if (= n 0)
                                    1
                                    (* n (fact (- n 1))))))
