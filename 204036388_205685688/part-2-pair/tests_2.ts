...
// checking split
console.log(splitEquation(E.makeEquation(<TExp>parseTE(`(Pair number number)`),<TExp>parseTE(`(Pair number number)`))))
console.log( [E.makeEquation(<TExp>parseTE(`number`),<TExp>parseTE(`number`)),E.makeEquation(<TExp>parseTE(`number`),<TExp>parseTE(`number`))])
...
assert.deepEqual(infer(`(cons #f #t)`),`(Pair boolean boolean)`);
console.log(infer(`(car (cons #f #t))`))
